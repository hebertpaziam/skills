...
- Exclusive HTML template or SCSS/CSS tasks
...
- **Always use path aliases for imports. Deep relative imports (`../../` or deeper) are strictly forbidden.**
  - Use `@<app-name>/<feature>/*` for app-internal cross-module imports (e.g., `@vendas/services/some.service`).
  - Use `@lib/<lib-name>` for shared library imports (e.g., `@lib/data-access`, `@lib/ui`, `@lib/utils`, `@lib/pipes`).
  - Use `@lib/<lib-name>/<sub-path>` for sub-path aliases when available (e.g., `@lib/data-access/config`, `@lib/data-access/enums`).
  - Relative imports (`./` or `../`) are only acceptable within the same feature folder (1 level maximum).
...
- No deep relative imports (`../../` or deeper) — all cross-module imports use path aliases.
...
- Interface vs type: [references/types-interface-vs-type.md](types-interface-vs-type.md)
- Interface generators: [references/types-interface-generators.md](types-interface-generators.md)
- Enums: [references/types-enums.md](types-enums.md)
- Domain modeling: [references/types-domain-modeling.md](types-domain-modeling.md)
- Generics: [references/types-generics.md](types-generics.md)
- Utility types: [references/types-utility-types.md](types-utility-types.md)
- Unions vs class hierarchies: [references/types-unions-vs-class-hierarchies.md](types-unions-vs-class-hierarchies.md)
- Narrowing and unknown: [references/types-narrowing-and-unknown.md](types-narrowing-and-unknown.md)
- Readonly and immutability: [references/types-readonly-and-immutability.md](types-readonly-and-immutability.md)
- Record vs Map: [references/types-record-vs-map.md](types-record-vs-map.md)
- Errors and result shapes: [references/types-errors-and-result-shapes.md](types-errors-and-result-shapes.md)
- Runtime validation: [references/types-runtime-validation.md](types-runtime-validation.md)

## Architecture and Module Design

Consult when designing functions, classes, modules, boundaries, or API surfaces.

- Functions vs classes: [references/architecture-functions-vs-classes.md](architecture-functions-vs-classes.md)
- Modules and boundaries: [references/architecture-modules-and-boundaries.md](architecture-modules-and-boundaries.md)
- DI and composition: [references/architecture-dependency-injection-and-composition.md](architecture-dependency-injection-and-composition.md)
- Side effects and ports: [references/architecture-side-effects-and-ports.md](architecture-side-effects-and-ports.md)
- API design: [references/architecture-api-design.md](architecture-api-design.md)
- File organization: [references/architecture-file-organization.md](architecture-file-organization.md)

## Design Principles

Consult when making structural or design decisions that affect maintainability.

- LIFT: [references/principles-lift.md](principles-lift.md)
- SOLID: [references/principles-solid.md](principles-solid.md)
- KISS and YAGNI: [references/principles-kiss-yagni.md](principles-kiss-yagni.md)
- Separation of Concerns: [references/principles-separation-of-concerns.md](principles-separation-of-concerns.md)
- Object Calisthenics: [references/principles-object-calisthenics.md](principles-object-calisthenics.md)

## Design Patterns

Consult only when there is real pressure for change, repetition, or decoupling.

- Patterns overview: [references/patterns-overview.md](patterns-overview.md)
- Creational: [references/patterns-creational.md](patterns-creational.md)
- Structural: [references/patterns-structural.md](patterns-structural.md)
- Behavioral: [references/patterns-behavioral.md](patterns-behavioral.md)
- When not to use patterns: [references/patterns-when-not-to-use.md](patterns-when-not-to-use.md)

## Pragmatic Design

Consult when evaluating duplication, abstraction trade-offs, or refactoring triggers.

- Duplication vs abstraction: [references/pragmatic-duplication-vs-abstraction.md](pragmatic-duplication-vs-abstraction.md)
- Refactoring triggers: [references/pragmatic-refactoring-triggers.md](pragmatic-refactoring-triggers.md)
