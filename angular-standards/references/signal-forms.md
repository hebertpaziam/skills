...
- Prefer Signal Forms in Angular v21 and newer.
- Do not use `null` or `undefined` as initial form values.
- If the project already uses legacy forms and migration is out of scope, keep the existing approach.
