...
- When modifying component styles or template classes, follow [component-styles.md](component-styles.md).
- Properties and methods must follow the ordering defined in the skill.
- Components should be small and focused; extract responsibilities into services or child components.
- Avoid complex logic in templates; prefer `computed`.
- Always create the corresponding `.spec.ts` file and follow [testing-conventions.md](testing-conventions.md) for unit tests.
