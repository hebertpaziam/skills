...
- Effects must be simple and narrow in scope.
- Do not use effects to synchronize state between signals.
- Complex logic and API calls should use RxJS in services instead.
