...
- Avoid HTML testing by default.
- Use harnesses only when the scope requires UI interaction validation.
- Keep assertions focused on behavior, not styling.
- For logic-only unit tests, follow [testing-conventions.md](testing-conventions.md).
