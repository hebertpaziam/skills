...
- Avoid mocking Router; use `RouterTestingHarness` for navigation tests.
- Do not validate HTML; focus on state and methods.
- For logic-only unit tests outside navigation flow, follow [testing-conventions.md](testing-conventions.md).
