...
- Only use Angular Aria if the dependency is already installed in the project.
- Do not expose `aria-*` attributes as configurable API (e.g., `aria-label`, `aria-describedby` inputs).
- Ensure AXE and WCAG AA compliance.
