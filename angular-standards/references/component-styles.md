...
- Refactoring styles to standardize BEM with strict nesting (see [bem-reference.md](bem-reference.md) for detailed BEM syntax and examples).
...
- Before creating new utility classes, consult [utility-classes.md](utility-classes.md) — reuse existing project classes when possible.
